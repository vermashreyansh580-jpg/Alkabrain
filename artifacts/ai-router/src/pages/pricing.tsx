...
import {
  getListBillingTiersQueryOptions,
...
export function Pricing() {
  ...
  const { data } = useQuery(getListBillingTiersQueryOptions());
    ...
    <div className="flex-1 overflow-auto bg-background p-6 md:p-10">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="rounded-lg border border-border/60 bg-card/40 p-6 text-sm text-muted-foreground space-y-2 max-w-3xl mx-auto">
          ...
          <p>
            Payments are processed securely by Razorpay. After your payment is captured, your account is upgraded automatically — usually within a few seconds. If your plan does not unlock within a minute, refresh the page or sign out and back in.
          </p>
          <p>
